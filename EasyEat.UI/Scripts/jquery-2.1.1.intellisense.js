intellisense.annotate(jQuery, {
  ...
  'boxModel': function() {
    Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being rendered using the W3C CSS Box Model.</summary>
    /// <returns type="Boolean" />
  },
  'browser': function() {
    Contains flags for the useragent, read from navigator.userAgent. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin. Please try to use feature detection instead.</summary>
    /// <returns type="PlainObject" />
  },
  'browser.version': function() {
    The version number of the rendering engine for the user's browser. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
  ...
  'cssHooks': function() {
    Hook directly into jQuery to override how particular CSS properties are retrieved or set, normalize CSS property naming, or create custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'now': function() {
    Return a number representing the current time.</summary>
    /// <returns type="Number" />
  },
  'param': function() {
    /// <signature>
  ...
  'sub': function() {
    Creates a new copy of jQuery whose properties and methods can be modified without affecting the original jQuery object.</summary>
    /// <returns type="jQuery" />
  },
  'support': function() {
    A collection of properties that represent the presence of different browser features or bugs. Primarily intended for jQuery's internal use; specific properties may be removed when they are no longer needed internally to improve page startup performance.</summary>
    /// <returns type="Object" />
  },
  'trim': function() {
    /// <signature>
...
intellisense.annotate(_object, {
  ...
  'disable': function() {
    Disable a callback list from doing anything more.</summary>
    /// <returns type="Callbacks" />
  },
  'disabled': function() {
    Determine if the callbacks list has been disabled.</summary>
    /// <returns type="Boolean" />
  },
  'empty': function() {
    Remove all of the callbacks from a list.</summary>
    /// <returns type="Callbacks" />
  },
  'fire': function() {
    /// <signature>
  ...
  'fired': function() {
    Determine if the callbacks have already been called at least once.</summary>
    /// <returns type="Boolean" />
  },
  'fireWith': function() {
    /// <signature>
  ...
  'lock': function() {
    Lock a callback list in its current state.</summary>
    /// <returns type="Callbacks" />
  },
  'locked': function() {
    Determine if the callbacks list has been locked.</summary>
    /// <returns type="Boolean" />
  },
  'remove': function() {
    /// <signature>
...
intellisense.annotate(_object, {
  ...
  'isRejected': function() {
    Determine whether a Deferred object has been rejected.</summary>
    /// <returns type="Boolean" />
  },
  'isResolved': function() {
    Determine whether a Deferred object has been resolved.</summary>
    /// <returns type="Boolean" />
  },
  'notify': function() {
    /// <signature>
  ...
  'state': function() {
    Determine the current state of a Deferred object.</summary>
    /// <returns type="String" />
  },
  'then': function() {
    /// <signature>
...
intellisense.annotate(jQuery.Event.prototype, {
  'currentTarget': function() {
    The current DOM element within the event bubbling phase.</summary>
    /// <returns type="Element" />
  },
  'data': function() {
    An optional object of data passed to an event method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
  'delegateTarget': function() {
    The element where the currently-called jQuery event handler was attached.</summary>
    /// <returns type="Element" />
  },
  'isDefaultPrevented': function() {
    Returns whether event.preventDefault() was ever called on this event object.</summary>
    /// <returns type="Boolean" />
  },
  'isImmediatePropagationStopped': function() {
    Returns whether event.stopImmediatePropagation() was ever called on this event object.</summary>
    /// <returns type="Boolean" />
  },
  'isPropagationStopped': function() {
    Returns whether event.stopPropagation() was ever called on this event object.</summary>
    /// <returns type="Boolean" />
  },
  'metaKey': function() {
    Indicates whether the META key was pressed when the event fired.</summary>
    /// <returns type="Boolean" />
  },
  'namespace': function() {
    The namespace specified when the event was triggered.</summary>
    /// <returns type="String" />
  },
  'pageX': function() {
    The mouse position relative to the left edge of the document.</summary>
    /// <returns type="Number" />
  },
  'pageY': function() {
    The mouse position relative to the top edge of the document.</summary>
    /// <returns type="Number" />
  },
  'preventDefault': function() {
    If this method is called, the default action of the event will not be triggered.</summary>
  },
  ...
  'result': function() {
    The last value returned by an event handler that was triggered by this event, unless the value was undefined.</summary>
    /// <returns type="Object" />
  },
  'stopImmediatePropagation': function() {
    Keeps the rest of the handlers from being executed and prevents the event from bubbling up the DOM tree.</summary>
  },
  'stopPropagation': function() {
    Prevents the event from bubbling up the DOM tree, preventing any parent handlers from being notified of the event.</summary>
  },
  'target': function() {
    The DOM element that initiated the event.</summary>
    /// <returns type="Element" />
  },
  'timeStamp': function() {
    The difference in milliseconds between the time the browser created the event and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
    Describes the nature of the event.</summary>
    /// <returns type="String" />
  },
  'which': function() {
    For key or mouse events, this property indicates the specific key or button that was pressed.</summary>
    /// <returns type="Number" />
  },
});
...
intellisense.annotate(jQuery.fn, {
  ...
  'all': function() {
    Selects all elements.</summary>
  },
  'andSelf': function() {
    Add the previous set of elements on the stack to the current set.</summary>
    /// <returns type="jQuery" />
  },
  'animate': function() {
    /// <signature>
  ...
  'animated': function() {
    Select all elements that are in the progress of an animation at the time the selector is run.</summary>
  },
  'append': function() {
    /// <signature>
  ...
  'button': function() {
    Selects all button elements and elements of type button.</summary>
  },
  'change': function() {
    /// <signature>
  ...
  'checkbox': function() {
    Selects all elements of type checkbox.</summary>
  },
  'checked': function() {
    Matches all elements that are checked or selected.</summary>
  },
  'child': function() {
    /// <signature>
  ...
  'contents': function() {
    Get the children of each element in the set of matched elements, including text and comment nodes.</summary>
    /// <returns type="jQuery" />
  },
  'context': function() {
    The DOM node context originally passed to jQuery(); if none was passed then context will likely be the document.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
  ...
  'disabled': function() {
    Selects all elements that are disabled.</summary>
  },
  'each': function() {
    /// <signature>
  ...
  'empty': function() {
    Select all elements that have no children (including text nodes).</summary>
  },
  'enabled': function() {
    Selects all elements that are enabled.</summary>
  },
  'end': function() {
    End the most recent filtering operation in the current chain and return the set of matched elements to its previous state.</summary>
    /// <returns type="jQuery" />
  },
  'eq': function() {
    /// <signature>
  ...
  'even': function() {
    Selects even elements, zero-indexed.  See also odd.</summary>
  },
  'fadeIn': function() {
    /// <signature>
  ...
  'file': function() {
    Selects all elements of type file.</summary>
  },
  'filter': function() {
    /// <signature>
  ...
  'first': function() {
    Selects the first matched element.</summary>
  },
  'first-child': function() {
    Selects all elements that are the first child of their parent.</summary>
  },
  'first-of-type': function() {
    Selects all elements that are the first among siblings of the same element name.</summary>
  },
  'focus': function() {
    /// <signature>
  ...
  'header': function() {
    Selects all elements that are headers, like h1, h2, h3 and so on.</summary>
  },
  'height': function() {
    /// <signature>
  ...
  'hidden': function() {
    Selects all elements that are hidden.</summary>
  },
  'hide': function() {
    /// <signature>
  ...
  'image': function() {
    Selects all elements of type image.</summary>
  },
  'index': function() {
    /// <signature>
  ...
  'innerHeight': function() {
    Get the current computed height for the first element in the set of matched elements, including padding but not border.</summary>
    /// <returns type="Number" />
  },
  'innerWidth': function() {
    Get the current computed width for the first element in the set of matched elements, including padding but not border.</summary>
    /// <returns type="Number" />
  },
  'input': function() {
    Selects all input, textarea, select and button elements.</summary>
  },
  ...
  'jquery': function() {
    A string containing the jQuery version number.</summary>
    /// <returns type="String" />
  },
  'keydown': function() {
    /// <signature>
  ...
  'last': function() {
    Selects the last matched element.</summary>
  },
  'last-child': function() {
    Selects all elements that are the last child of their parent.</summary>
  },
  'last-of-type': function() {
    Selects all elements that are the last among siblings of the same element name.</summary>
  },
  'length': function() {
    The number of elements in the jQuery object.</summary>
    /// <returns type="Number" />
  },
  'live': function() {
    /// <signature>
  ...
  'odd': function() {
    Selects odd elements, zero-indexed.  See also even.</summary>
  },
  'off': function() {
    /// <signature>
  ...
  'offsetParent': function() {
    Get the closest ancestor element that is positioned.</summary>
    /// <returns type="jQuery" />
  },
  'on': function() {
    /// <signature>
  ...
  'only-child': function() {
    Selects all elements that are the only child of their parent.</summary>
  },
  'only-of-type': function() {
    Selects all elements that have no siblings with the same element name.</summary>
  },
  ...
  'password': function() {
    Selects all elements of type password.</summary>
  },
  'position': function() {
    Get the current coordinates of the first element in the set of matched elements, relative to the offset parent.</summary>
    /// <returns type="Object" />
  },
  'prepend': function() {
    /// <signature>
  ...
  'radio': function() {
    Selects all  elements of type radio.</summary>
  },
  'ready': function() {
    /// <signature>
  ...
  'reset': function() {
    Selects all elements of type reset.</summary>
  },
  'resize': function() {
    /// <signature>
  ...
  'root': function() {
    Selects the element that is the root of the document.</summary>
  },
  'scroll': function() {
    /// <signature>
  ...
  'selected': function() {
    Selects all elements that are selected.</summary>
  },
  'selector': function() {
    A selector representing selector passed to jQuery(), if any, when creating the original set.</summary>
    /// <returns type="String" />
  },
  'serialize': function() {
    Encode a set of form elements as a string for submission.</summary>
    /// <returns type="String" />
  },
  'serializeArray': function() {
    Encode a set of form elements as an array of names and values.</summary>
    /// <returns type="Array" />
  },
  'show': function() {
    /// <signature>
  ...
  'size': function() {
    Return the number of elements in the jQuery object.</summary>
    /// <returns type="Number" />
  },
  'slice': function() {
    /// <signature>
  ...
  'target': function() {
    Selects the target element indicated by the fragment identifier of the document's URI.</summary>
  },
  'text': function() {
    /// <signature>
  ...
  'toArray': function() {
    Retrieve all the DOM elements contained in the jQuery set, as an array.</summary>
    /// <returns type="Array" />
  },
  'toggle': function() {
    /// <signature>
  ...
  'unwrap': function() {
    Remove the parents of the set of matched elements from the DOM, leaving the matched elements in their place.</summary>
    /// <returns type="jQuery" />
  },
  'val': function() {
    /// <signature>
  ...
  'visible': function() {
    Selects all elements that are visible.</summary>
  },
  'width': function() {
    /// <signature>
